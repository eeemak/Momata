                                    ...
                                    <div class="sc_donations_columns_wrap">
                                        <div class="post_item_excerpt post_type_donation sc_donations_column-1_3">
                                            <div class="post_featured">
                                                <img width="570" height="320" src="{{ asset('assets/website/images/image-16-570x320.jpg') }}" class="attachment-thumb_med size-thumb_med" alt="Education to Every Child" />
                                            </div>
                                            <!-- .post_featured -->
                                            <div class="post_body">
                                        ...
                                        <div class="post_item_excerpt post_type_donation sc_donations_column-1_3">
                                            <div class="post_featured">
                                                <img width="570" height="320" src="{{ asset('assets/website/images/image-14-570x320.jpg') }}" class="attachment-thumb_med size-thumb_med" alt="Primary School for Kids" /> </div>
                                            <!-- .post_featured -->
                                            <div class="post_body">
                                                <div class="post_header entry-header">
                                        ...
                                        <div class="post_item_excerpt post_type_donation sc_donations_column-1_3">
                                            <div class="post_featured">
                                                <img width="570" height="320" src="{{ asset('assets/website/images/image-15-570x320.jpg') }}" class="attachment-thumb_med size-thumb_med" alt="Patient and Family Support" /> </div>
                                            <!-- .post_featured -->
                                            <div class="post_body">
                                                <div class="post_header entry-header">
												...
												<div id="sc_events_1937176018_wrap" class="sc_events_wrap">
													<div id="sc_events_1937176018" class="sc_events sc_events_style_events-1  margin_bottom_medium">
														<div class="sc_columns columns_wrap">
															<div class="column-1_2 column_padding_bottom">
																<div id="sc_events_1937176018_1" class="sc_events_item sc_events_item_1 odd first">
																	<div class="sc_events_item_featured post_featured">
																		<div class="post_thumb" data-image="{{ asset('assets/website/images/image-6.jpg') }}" data-title="Is a Nonprofit Internship the Best Choice for You?">
																			<a class="hover_icon hover_icon_link" href="event.html"><img width="770" height="434" alt="Is a Nonprofit Internship the Best Choice for You?" src="{{ asset('assets/website/images/image-6-770x434.jpg') }}"></a>
																		</div>
																	</div>
															...
															<div class="column-1_2 column_padding_bottom">
																<div id="sc_events_1937176018_2" class="sc_events_item sc_events_item_2 even">
																	<div class="sc_events_item_featured post_featured">
																		<div class="post_thumb" data-image="{{ asset('assets/website/images/image-8.jpg') }}" data-title="Volunteers All-state Meeting">
																			<a class="hover_icon hover_icon_link" href="event.html"><img width="770" height="434" alt="Volunteers All-state Meeting" src="{{ asset('assets/website/images/image-8-770x434.jpg') }}"></a>
																		</div>
																	</div>
																	<div class="sc_events_item_content">
