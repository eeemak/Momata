...
<div class="top_panel_title top_panel_style_1  title_present scheme_original">
    <div class="top_panel_title_inner top_panel_inner_style_1  title_present_inner">
        <div class="content_wrap">
            <h1 class="page_title">Our Mission</h1> </div>
    </div>
</div>
                        ...
                        <div class="column_container">
                            <div class="column-inner">
                                <div class="wrapper">
                                    ...
                                    <div id="sc_donations_52156518" class="sc_donations sc_donations_style_excerpt">
                                        <div class="sc_donations_columns_wrap">
                                            ...
                                            <div class="post_item_excerpt post_type_donation sc_donations_column-1_3">
                                                ...
                                                <!-- .post_featured -->
                                                <div class="post_body">
                                                    <div class="post_header entry-header"><h4 class="entry-title"><a href="{{ route('mission_detail', $item) }}" rel="bookmark">{{ $item->title }}</a></h4> </div>
                                                    <!-- .entry-header -->
                                                    <div class="post_content entry-content">
                                                        <p>{{ str_limit($item->description) }}</p>
                                                        <a class="more-link" href="{{ route('mission_detail', $item) }}">Detail</a> </div>
                                                    <!-- .entry-content -->
                                                </div>
                                                <!-- .post_body -->
                                            </div>
                                    ...
                                    <!-- /.sc_donations -->
                                    {{ $mission_list->links('website.layouts.pagination') }}
                                    <br><br>
                                </div>
                            </div>
                        </div>
